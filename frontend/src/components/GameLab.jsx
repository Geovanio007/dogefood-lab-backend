...
// Wallet Connection Gate Component (extracted to avoid hook order issues)
      ...
      <Card className="game-card max-w-2xl mx-auto">
        ...
        <CardContent className="text-center space-y-8">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="text-center p-6 bg-gradient-to-br from-green-400/30 to-blue-500/20 rounded-3xl border-2 border-green-300/50">
              <div className="text-4xl mb-3">🧪</div>
              <h4 className="font-bold text-white text-xl mb-3 playful-title">Create Amazing Treats</h4>
              <p className="text-white/80 playful-text">Mix ingredients to create unique DogeFood treats!</p>
            </div>
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-100">
                You're experiencing the game interface! Connect your wallet to save progress and earn real rewards.
              </p>
            </div>
            <button
